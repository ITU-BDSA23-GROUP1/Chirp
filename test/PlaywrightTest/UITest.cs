...
{ 
    ...
    [Test]
    public async Task RegisterAndDeleteUser()
    {
        ...
        await Page.GetByPlaceholder("name@example.com").ClickAsync();
        await Page.GetByPlaceholder("name@example.com").FillAsync(UserName + "@willBeDeleted.com");
        ...
        //Delete User
        await Page.GetByRole(AriaRole.Link, new() { Name = "account settings" }).ClickAsync();
        ...
        await Page.GetByPlaceholder("Please enter your password.").FillAsync("Test!123");
        await Page.GetByRole(AriaRole.Button, new() { Name = "Forget me!" }).ClickAsync();

        //Try to login with deleted user
        await Page.GetByRole(AriaRole.Link, new() { Name = "Login" }).ClickAsync();
        await Page.GetByPlaceholder("name@example.com").ClickAsync();
        await Page.GetByPlaceholder("name@example.com").FillAsync("hej@willBeDeleted.com");
        await Page.GetByPlaceholder("password").ClickAsync();
        await Page.GetByPlaceholder("password").FillAsync("Test!123");
        await Page.GetByRole(AriaRole.Button, new() { Name = "Log in" }).ClickAsync();
