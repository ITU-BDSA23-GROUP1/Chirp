...
![Illustration of the _Chirp!_ architecture in the small.](images/onion-3.drawio.png)
...
![Illustration of the architecture of the deployed _Chirp!_ application.](images/deployment3.drawio.png)
